				...
				<div class="container">
					<div class="col-lg-8 col-lg-offset-2">
						<ol class="breadcrumb breadcrumb-color">
							...
							<li class="active">Admin: Edit Job</li>
						</ol>
						
						<?
							$jobno = $_POST['jobno'];
							//echo $tool_id;
							$query = "SELECT * FROM jobs WHERE jobNum = '$jobno'";
							//echo $query;
						...
						<div class="jumbotron jumbotron-register center-block">
							<form action="updatejob_process.php" method="post">
								<h3 class="dark-grey">Edit: <? 	echo $JOBNUM . ' - ' . $JOBNAME;?></h3>
												
								<div class="form-group col-lg-6">
									<label>Job #</label>
									<input type="text" name="jobno" class="form-control" id="jobno" value="<? echo $JOBNUM;?>" 
									required autofocus
								...
								<div class="form-group col-lg-6">
									<label>Name</label>
									<input type="text" name="name" class="form-control" id="name" value="<? echo $JOBNAME; ?>" required>
								</div>		
