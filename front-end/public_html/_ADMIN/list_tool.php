							...
							<h3>Tools</h3>
							  <table class="table table-striped">
								...
								<?
									while($x < $max) {
									echo '<tr>
											<td>' . $array[$x][bayleyID] . '</td>
											<td>' . $array[$x][category] . '</td>
											<td>' . $array[$x][name] . '</td>
											<td>' . $array[$x][dailyPrice] . '</td>
											<td>' . $array[$x][weeklyPrice] . '</td>
											<td>' . $array[$x][monthlyPrice] . '</td>
											<td>' . $array[$x][toolValue] . '</td>
											<td>' . $array[$x][status] . '</td>
											<td>' . $array[$x][location] . '</td>
										  </tr>';
									$x++;
								}
								?>	  
