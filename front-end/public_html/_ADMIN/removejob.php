...
<html>
	<head>
		<!--TITLE-->
			<title>ToolTime: Remove Job</title>
				...
				<div class="container">
					<div class="col-lg-8 col-lg-offset-2">
						<ol class="breadcrumb breadcrumb-color">
							...
							<li class="active">Admin: Remove Job</li>
						</ol>
						
						<div class="jumbotron jumbotron-register center-block">
							<form action="removejob_process.php" method="post">
								<h3 class="dark-grey">Job Removal</h3>
							...
							?>
								...
								<label for ="location">Select Job:</label>
