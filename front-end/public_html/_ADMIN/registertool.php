						...
						<div class="jumbotron jumbotron-register center-block">
							<form action="addtool.php" method="post">
								...
								<div class="form-group col-lg-6">
									...
									<input type="text" name="bercoid" class="form-control" id="bercoid" value="" 
									required autofocus
								...
								<div class="form-group col-lg-6">
									...
									<input type="text" name="dailyprice" class="form-control" id="dailyprice" value="" 
									required autofocus
									title="Numbers only! 00.00"
									pattern="[0-9]*.[0-9]*"
									/>
								</div>
								...
								<div class="form-group col-lg-6">
									...
									<input type="text" name="weeklyprice" class="form-control" id="weeklyprice" value="" 
									required autofocus
									title="Numbers only! 00.00"
									pattern="[0-9]*.[0-9]*"
									/>
								...
								<div class="form-group col-lg-6">
									...
									<input type="text" name="monthlyprice" class="form-control" id="monthlyprice" value="" 
									required autofocus
									title="Numbers only! 00.00"
									pattern="[0-9]*.[0-9]*"
									/>
								...
								<div class="form-group col-lg-6">
									...
									<input type="text" name="toolvalue" class="form-control" id="toolvalue" value="" 
									required autofocus
									title="Numbers only! 00.00"
									pattern="[0-9]*.[0-9]*"
									/>
