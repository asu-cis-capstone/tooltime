...
<html>
	<head>
		<!--TITLE-->
			<title>ToolTime: Remove Employee</title>
				...
				<div class="container">
					<div class="col-lg-8 col-lg-offset-2">
						<ol class="breadcrumb breadcrumb-color">
							...
							<li class="active">Admin: Remove Employee</li>
						</ol>
						
						<div class="jumbotron jumbotron-register center-block">
							<form action="removeemployee_process.php" method="post">
								<h3 class="dark-grey">Employee Removal</h3>
							...
							?>
								...
								<label for ="location">Select Employee:</label>
									<select name="id" class="form-control" value="" id="id" required>
										<?
											while($x < $max) {
												echo '<option value="' . $array[$x][id] . '">' . $array[$x][firstName] . ' ' . $array[$x][lastName] . '</option>';
												$x++;
											}
										?>		
									</select>
